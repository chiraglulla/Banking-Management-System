            ...
            <div class="m-auto col-12 col-sm-8">
                <form action="transfer.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-10">
                            <input id="toEmail" class="validate form-control p-2" type="text" name="to" value="<?php echo $to; ?>">
                    ...
                    <div class="form-group row"> 
                        ...
                        <div class="col-12 col-sm-10">
                            <input id="amount" class="validate form-control p-2" type="number" name="amount" value="<?php echo $amount; ?>">
